  ...
  render() {
    return (
      <View>
        ...
        <TextInput value={this.state.firstName} onChangeText={this.handleTextChanged}/>
        <Text>Last Name</Text>
        <TextInput value={this.state.lastName} onChangeText={this.handleTextChanged}/>
        <Text>Username</Text>
        <TextInput value={this.state.username} onChangeText={this.handleTextChanged}/>
        <Text>Password</Text>
        <TextInput value={this.state.password} onChangeText={this.handleTextChanged}/>
        <Text>Comfirm Password</Text>
        <TextInput value={this.state.comfirmPassword} onChangeText={this.handleTextChanged}/>
        <Text>Picture of You</Text>
        <TextInput value={this.state.url} onChangeText={this.handleTextChanged}/>
        <Text>Gender</Text>
        <TextInput value={this.state.gender} onChangeText={this.handleTextChanged}/>
      </View>
